...
start "Travel Planner - Streamlit (:8501)" cmd /k "call venv\Scripts\activate.bat && set PYTHONPATH=%cd% && python -m streamlit run frontend\legacy-streamlit\app.py --server.port 8501"
