...
> The canonical frontend is now located at `frontend/web/`. See the [N16 README](../web/README.md).
...
- To run the legacy interface: `run-legacy.bat`

---

## Migration to N16

The project frontend is now **N16 — Next.js Web App** (`frontend/web/`).
...
See [frontend/web/README.md](../web/README.md) for the current frontend documentation.
