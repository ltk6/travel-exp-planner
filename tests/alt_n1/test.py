...
from backend.modules.alt_n1_embedding import embed, embed_batch
...
def run_batch_tests(test_set: list[dict], filename: str):
    ...
    is_query = "user" in filename
    results = embed_batch(inputs, is_query=is_query)
